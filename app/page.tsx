...
export default function WeiPhotographyStudio() {
  ...
  const portfolio = [
    {
      image: '/photos/graduation-1.jpg',
      title: 'Graduation Stories',
    },
    {
      image: '/photos/portrait-1.jpg',
      title: 'Portrait Sessions',
    },
    {
      image: '/photos/editorial-1.jpg',
  ...
  return (
    <div className="min-h-screen bg-[#f8f5f0] text-[#2b2b2b] font-serif">
      <header className="relative h-screen overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between px-10 py-8 text-white backdrop-blur-md bg-black/20">
          ...
          <div className="hidden md:flex gap-8 text-sm tracking-wide uppercase text-white/90">
            ...
            <a href="#booking" className="hover:opacity-60 transition">
              Booking
            </a>
          </div>
        </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {packages.map((pkg) => (
              ...
              >
                ...
                <button className="mt-10 w-full rounded-full bg-black px-6 py-4 text-sm uppercase tracking-[0.2em] text-white transition hover:opacity-90">
                  Reserve Package
                </button>
              </div>
            ))}
      ...
      <section
        id="calendar"
        className="bg-[#ece6dc] px-6 py-24 md:px-16"
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-neutral-600 max-w-2xl mx-auto leading-relaxed">
              Reserve your preferred session date early. Weekend bookings and golden-hour outdoor sessions fill quickly.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-2xl border border-neutral-200 px-5 py-4 outline-none focus:border-black"
                >
              ...
              <div>
                ...
                <select className="w-full rounded-2xl border border-neutral-200 px-5 py-4 outline-none focus:border-black">
                  <option>Glow Session</option>
                  <option>Glam Session</option>
                  <option>Glam Outdoors</option>
                  <option>Shimmer Session</option>
                  <option>Shimmer Outdoors</option>
                </select>
              </div>
              ...
              <button className="w-full rounded-full bg-black px-8 py-5 text-sm uppercase tracking-[0.25em] text-white transition hover:opacity-90">
                Request Booking
              </button>

              {selectedDate && (
                <div className="rounded-2xl bg-[#f8f5f0] p-6 text-center border border-neutral-200">
                  <p className="text-lg font-light">
                    Selected Date: {selectedDate}
                  </p>
                  <p className="mt-2 text-neutral-500 text-sm">
                    Your booking request will be confirmed manually.
                  </p>
                </div>
              )}
            </div>
